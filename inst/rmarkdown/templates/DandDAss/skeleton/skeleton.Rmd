...
<!-- This part is a text comment that will not show up in the final Word document.  The following chunk of R code sets up R markdown so that the code will be displayed in the final word document alongside its output. You should always leave it as the first chunk of code. -->
